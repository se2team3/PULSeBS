 ...
 */
const func = async ({n_students, datetime} = def_options) => {
    console.log("here")
console.log(process.env.NODE_ENV)
    ...
    const data = {
        ...
        assign2:{},
        lecture: { datetime },
        students: [studentObj(counter.get())],
        booked: 0
    };
...
module.exports = { reset, createTables, teacherObj, studentObj, func }
